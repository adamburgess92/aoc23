...
val seed_soil:List[String] = Utils.readLines("day5/seed_to_soil.txt")
val soil_fert:List[String] = Utils.readLines("day5/soil_to_fertilizer.txt")
val fert_water:List[String] = Utils.readLines("day5/fertilizer_to_water.txt")
val water_light:List[String] = Utils.readLines("day5/water_to_light.txt")
val light_temp:List[String] = Utils.readLines("day5/light_to_temperature.txt")
val temp_humidity:List[String] = Utils.readLines("day5/temperature_to_humidity.txt")
val humi_loc:List[String] = Utils.readLines("day5/humidity_to_location.txt")

val test_seed_soil:List[String] = Utils.readLines("day5/test_seed_to_soil.txt")
val test_soil_fert:List[String] = Utils.readLines("day5/test_soil_to_fertilizer.txt")
val test_fert_water:List[String] = Utils.readLines("day5/test_fertilizer_to_water.txt")
val test_water_light:List[String] = Utils.readLines("day5/test_water_to_light.txt")
val test_light_temp:List[String] = Utils.readLines("day5/test_light_to_temperature.txt")
val test_temp_humidity:List[String] = Utils.readLines("day5/test_temperature_to_humidity.txt")
val test_humi_loc:List[String] = Utils.readLines("day5/test_humidity_to_location.txt")
